...
Pod::Spec.new do |s|
  s.name             = 'LFVDKnob'
  s.version          = '0.1.0'
  s.summary          = 'LFVDKnob is a rotary knob designed for audio applications.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
LFVDKnob is designable via the interface builder.
                       DESC
  ...
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/LFVDKnob.git', :tag => s.version.to_s }
